...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 21 09:59:48 2019
...
def group_and_analyze(C, Idx, flag):#, nor):
    ...
    return coeff_list, W_list, lbl_y

def degroup_and_decode(coeff_list, W_list, lbl_y):
    m, n = np.shape(lbl_y)
    ...
    while np.count_nonzero(lbl_y) > 0:
        ...
        while j < n:
            ...
            if lbl_y[i, j] == 1:           #8x8
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((8*8, 8*8)))
                #a1 = 8*i
                #b1 = 8*(i+1)
                #a2 = 8*j
                #b2 = 8*(j+1)
                CYrec[8*i:8*(i+1), 8*j:8*(j+1)] = blk.reshape((8, 8))
                lbl_y[i, j] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 1
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((8*16, 8*16)))
                #a1 = 8*i
                #b1 = 8*(i+1)
                #a2 = 8*j
                #b2 = 8*(j+2)
                CYrec[8*i:8*(i+1), 8*j:8*(j+2)] = blk.reshape((8, 16))
                lbl_y[i, j:j+2] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 2
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((16*8, 16*8)))
                #a1 = 8*i
                #b1 = 8*(i+2)
                #a2 = 8*j
                #b2 = 8*(j+1)
                CYrec[8*i:8*(i+2), 8*j:8*(j+1)] = blk.reshape((16, 8))
                lbl_y[i:i+2, j] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 1
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((8*24, 8*24)))
                #a1 = 8*i
                #b1 = 8*(i+1)
                #a2 = 8*j
                #b2 = 8*(j+3)
                CYrec[8*i:8*(i+1), 8*j:8*(j+3)] = blk.reshape((8, 24))
                lbl_y[i, j:j+3] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 3
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((24*8, 24*8)))
                #a1 = 8*i
                #b1 = 8*(i+3)
                #a2 = 8*j
                #b2 = 8*(j+1)
                CYrec[8*i:8*(i+3), 8*j:8*(j+1)] = blk.reshape((24, 8))
                lbl_y[i:i+3, j] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 1
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((8*32, 8*32)))
                #a1 = 8*i
                #b1 = 8*(i+1)
                #a2 = 8*j
                #b2 = 8*(j+4)
                CYrec[8*i:8*(i+1), 8*j:8*(j+4)] = blk.reshape((8, 32))
                lbl_y[i, j:j+4] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 4
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((16*16, 16*16)))
                #a1 = 8*i
                #b1 = 8*(i+2)
                #a2 = 8*j
                #b2 = 8*(j+2)
                CYrec[8*i:8*(i+2), 8*j:8*(j+2)] = blk.reshape((16, 16))
                lbl_y[i:i+2, j:j+2] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 2
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((32*8, 32*8)))
                #a1 = 8*i
                #b1 = 8*(i+4)
                #a2 = 8*j
                #b2 = 8*(j+1)
                CYrec[8*i:8*(i+4), 8*j:8*(j+1)] = blk.reshape((32, 8))
                lbl_y[i:i+4, j] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 1
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((16*24, 16*24)))
                #a1 = 8*i
                #b1 = 8*(i+2)
                #a2 = 8*j
                #b2 = 8*(j+3)
                CYrec[8*i:8*(i+2), 8*j:8*(j+3)] = blk.reshape((16, 24))
                lbl_y[i:i+2, j:j+3] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 3
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((24*16, 24*16)))
                #a1 = 8*i
                #b1 = 8*(i+3)
                #a2 = 8*j
                #b2 = 8*(j+2)
                CYrec[8*i:8*(i+3), 8*j:8*(j+2)] = blk.reshape((24, 16))
                lbl_y[i:i+3, j:j+2] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 2
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((16*32, 16*32)))
                #a1 = 8*i
                #b1 = 8*(i+2)
                #a2 = 8*j
                #b2 = 8*(j+4)
                CYrec[8*i:8*(i+2), 8*j:8*(j+4)] = blk.reshape((16, 32))
                lbl_y[i:i+2, j:j+4] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 4
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((32*16, 32*16)))
                #a1 = 8*i
                #b1 = 8*(i+4)
                #a2 = 8*j
                #b2 = 8*(j+2)
                CYrec[8*i:8*(i+4), 8*j:8*(j+2)] = blk.reshape((32, 16))
                lbl_y[i:i+4, j:j+2] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 2
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((24*24, 24*24)))
                #a1 = 8*i
                #b1 = 8*(i+3)
                #a2 = 8*j
                #b2 = 8*(j+3)
                CYrec[8*i:8*(i+3), 8*j:8*(j+3)] = blk.reshape((24, 24))
                lbl_y[i:i+3, j:j+3] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 3
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((24*32, 24*32)))
                #a1 = 8*i
                #b1 = 8*(i+3)
                #a2 = 8*j
                #b2 = 8*(j+4)
                CYrec[8*i:8*(i+3), 8*j:8*(j+4)] = blk.reshape((24, 32))
                lbl_y[i:i+3, j:j+4] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 4
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((32*24, 32*24)))
                #a1 = 8*i
                #b1 = 8*(i+4)
                #a2 = 8*j
                #b2 = 8*(j+3)
                CYrec[8*i:8*(i+4), 8*j:8*(j+3)] = blk.reshape((32, 24))
                lbl_y[i:i+4, j:j+3] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 3
                ...
                #coeffs = coeff_list[0]
                blk = fn.igft2(coeff_list[0], W_list[0].reshape((32*32, 32*32)))
                #a1 = 8*i
                #b1 = 8*(i+4)
                #a2 = 8*j
                #b2 = 8*(j+4)
                CYrec[8*i:8*(i+4), 8*j:8*(j+4)] = blk.reshape((32, 32))
                lbl_y[i:i+4, j:j+4] = 0
                coeff_list.pop(0)
                W_list.pop(0)
                j += 4
